...
- `skills/restate/references/<sdk>/api-and-pitfalls.md` - Setup, API patterns, determinism rules, error handling, and pitfalls for the detected SDK

## Context-based references (load when relevant)

| Context | Reference |
|---------|-----------|
| Design a new application, choose service types | `skills/restate/references/design-and-architecture.md` |
| Convert from a workflow orchestrator or existing app | `skills/restate/references/translate-to-restate.md` |
| Invoking services, interacting with invocations (cancel, attach, idempotency, sends, Kafka) | `skills/restate/references/invocation-lifecycle.md` |
| Build AI agent with Vercel AI SDK | `skills/restate/references/ts/restate-vercel-ai-agents.md` |
| Build AI agent with OpenAI Agents SDK | `skills/restate/references/python/restate-openai-agents-agents.md` |
| Build AI agent with Google ADK | `skills/restate/references/python/restate-google-adk-agents.md` |
| Build AI agent with Pydantic AI | `skills/restate/references/python/restate-pydantic-ai-agents.md` |
| Debug errors, stuck invocations, journal mismatches | `skills/restate/references/debug-applications.md` |
...
| Question                                                          | Consult |
|-------------------------------------------------------------------|---------|
| Restate service types, stateful entities, keying, concurrency?    | `skills/restate/references/design-and-architecture.md` |
| Non-Restate orchestrator in the project?                          | `skills/restate/references/translate-to-restate.md` |
| Invoking, cancelling, deduplicating, or attaching to invocations? | `skills/restate/references/invocation-lifecycle.md` |
...
See the Testing section of `skills/restate/references/<sdk>/api-and-pitfalls.md` for the working scaffold.
